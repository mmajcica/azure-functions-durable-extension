...
namespace Microsoft.Azure.WebJobs.Extensions.DurableTask
{
    ...
    internal class TaskActivityShim : TaskActivity
    {
        ...
        private readonly IFunctionExecutorWrapper executorWrapper;
        private readonly ITriggeredFunctionExecutor executor;
        private readonly string activityName;

        public TaskActivityShim(
            DurableTaskExtension config,
            IFunctionExecutorWrapper executorWrapper,
            ITriggeredFunctionExecutor executor,
            string activityName)
        {
            this.config = config ?? throw new ArgumentNullException(nameof(config));
            this.executorWrapper = executorWrapper ?? throw new ArgumentNullException(nameof(executorWrapper));
